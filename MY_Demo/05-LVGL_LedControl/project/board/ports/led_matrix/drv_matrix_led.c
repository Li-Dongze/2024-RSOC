...
// 全红
void LED_AllRed(void)
{
    
}

// 全绿
void LED_AllGreen(void)
{
    led_matrix_fill(LT_GREEN);
}

// 全蓝
void LED_AllBlue(void)
{
    led_matrix_fill(LT_BLUE);
}

// 全彩
void LED_MulticColour(void)
{
    led_matrix_test2();
...
// 设置区域灯带颜色
void LED_Set(uint16_t id, RGBColor_TypeDef Color)
{
    switch(id)
    {
        case 0:
            Set_LEDColor(0, Color);
            Set_LEDColor(1, Color);
            Set_LEDColor(2, Color);
            Set_LEDColor(3, Color);
            Set_LEDColor(4, Color);
            Set_LEDColor(5, Color);
            RGB_Reflash();
            break;

        case 1:
            Set_LEDColor(6, Color);
            Set_LEDColor(7, Color);
            Set_LEDColor(8, Color);
            Set_LEDColor(9, Color);
            Set_LEDColor(10, Color);
            Set_LEDColor(11, Color);
            RGB_Reflash();
            break;

        case 2:
            Set_LEDColor(12, Color);
            Set_LEDColor(13, Color);
            Set_LEDColor(14, Color);
            Set_LEDColor(15, Color);
            Set_LEDColor(16, Color);
            Set_LEDColor(17, Color);
            RGB_Reflash();
            break;
